...
func (x *SetStudetResponse) Reset() {
	*x = SetStudetResponse{}
...
func (x *SetStudetResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetStudetResponse) ProtoMessage() {}

func (x *SetStudetResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_student_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetStudetResponse.ProtoReflect.Descriptor instead.
func (*SetStudetResponse) Descriptor() ([]byte, []int) {
	return file_proto_student_proto_rawDescGZIP(), []int{2}
}

func (x *SetStudetResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_proto_student_proto_rawDesc = []byte{
	...
	0x52, 0x02, 0x69, 0x64, 0x22, 0x23, 0x0a, 0x11, 0x53, 0x65, 0x74, 0x53, 0x74, 0x75, 0x64, 0x65,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0x88, 0x01, 0x0a, 0x0e, 0x53, 0x74,
	0x75, 0x64, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3a, 0x0a, 0x0a,
	...
	0x2e, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x12, 0x3a, 0x0a, 0x0a, 0x53, 0x65, 0x74, 0x53,
	0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x12, 0x10, 0x2e, 0x73, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74,
	0x2e, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x1a, 0x1a, 0x2e, 0x73, 0x74, 0x75, 0x64, 0x65,
	0x6e, 0x74, 0x2e, 0x53, 0x65, 0x74, 0x53, 0x74, 0x75, 0x64, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1d, 0x5a, 0x1b, 0x73, 0x61, 0x6d, 0x2e, 0x65, 0x73, 0x63, 0x6f,
...
var file_proto_student_proto_goTypes = []any{
	...
	(*SetStudetResponse)(nil), // 2: student.SetStudetResponse
}
var file_proto_student_proto_depIdxs = []int32{
	...
	2, // 3: student.StudentService.SetStudent:output_type -> student.SetStudetResponse

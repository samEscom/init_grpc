...
type StudentServiceClient interface {
	...
	SetStudent(ctx context.Context, in *Student, opts ...grpc.CallOption) (*SetStudetResponse, error)
}
...
func (c *studentServiceClient) SetStudent(ctx context.Context, in *Student, opts ...grpc.CallOption) (*SetStudetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetStudetResponse)
...
type StudentServiceServer interface {
	...
	SetStudent(context.Context, *Student) (*SetStudetResponse, error)
...
func (UnimplementedStudentServiceServer) SetStudent(context.Context, *Student) (*SetStudetResponse, error) {
